...
page = mechanize.get('http://www.youm7.com/%D8%B3%D9%8A%D8%A7%D8%B3%D8%A9-319')

# sports html file
p ("creating the file html")
outfile = File.new("politics1.html","w+")
nextfile = File.new("politics2.html","w+")
lastfile = File.new("politics3.html","w+")
x ='<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
      ...
      <nav class="navbar navbar-inverse" role="navigation">      
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav main_nav">
            ...
            <li><a href="politics1.html">سياسة</a></li>            
...
links = page.search "//div[@class='newsBriefBlock']/div[@class='newsListContentData']/h3/a"
  ...
  links.each do |l|
	...
	if news_num <= 5
	   x ='<li><a href="./politics/'+"#{file}"+'.html"><img src="img/news_thumbnail3.jpg" alt="">' + "#{title}" + '</a></li> '
	   outfile.puts(x)
	   nextfile.puts(x)
	   lastfile.puts(x)
	   news_num += 1
	...
	if news_num >5 and news_num <=9
	   x = '<div class="single_iteam">
              <a href="./politics/'+file+'.html">' + "#{image}" +'</a>
              <div class="slider_article">
                <h2><a class="slider_thittle" href="./politics/'+file+'.html">' + "#{title}" + '</a></h2>
	...
	if news_num >9 and news_num <= 14
	   x = '<li>
		  <div class="media">
                    <a href="./politics/'+file+'.html" class="media-left">' + "#{image}" + '</a>
                    <div class="media-body">
                      <a href="./politics/'+file+'.html" class="catg_title">' + "#{title}" + '</a>                        
                    </div>
                  </div>
                </li>'
	   outfile.puts(x)
		          ...
		          <ul class="business_catgnav wow fadeInDown">
		            <li>
		              <figure class="bsbig_fig">
		                <a href="./politics/'+file+'.html" class="featured_img"> '+"#{image}"+'
				<span class="overlay"></span>
		                </a>
		                <figcaption>
		                  <a href="./politics/'+file+'.html">'+"#{title}"+'</a>
		          ...
		          <ul class="business_catgnav">
		            <li>
		              <figure class="bsbig_fig wow fadeInDown">
		                <a href="./politics/'+file+'.html" class="featured_img">'+"#{image}"+'<span class="overlay"></span>
		                </a>
		                <figcaption>
		                  <a href="./politics/'+file+'.html">'+"#{title}"+'</a>
		                </figcaption>
...
#============================================================================================================
 page = mechanize.get('http://www.elwatannews.com/subsection/110')
	  links = page.search "//div[@class='wrapper']/div[@class='white']/div[@class='content-inner']/div[@class='right-area']/div[2]/div[@id='tab1']/div[@class='content-subsec']//a"
  	  left = true
	  links.each do |l|
	    ...
	    title = title.tr('"', "'")
	    image = result_page.at("//img[@class='article-img']") 

	    date = result_page.at("//div[@class='written-time']/span[@class='atr_2']").text 
...
#===========================================================================================
page = mechanize.get('http://www.ahram.org.eg/Category/121670/26/%D8%A3%D8%AE%D8%A8%D8%A7%D8%B1-%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9-%D9%88-%D8%B9%D8%A7%D9%84%D9%85%D9%8A%D8%A9.aspx')
	  links = page.search "//div[@class='block_text_outer']//a"
  	  left = true
	  links.each do |l|
	    ...
	    title = result_page.at("//div[@class='block_outer']/div[@id='ctl00_ContentPlaceHolder1_divTitle']").text # Print the page title
	    title = title.tr('"', "'")
	    image = result_page.at("//div[@class='top_news_img']/div[1]/img") 

	    date = result_page.at("//div[@id='ctl00_divIssueDate']/span").text 

	    details = result_page.at("///div[@class='Basic-Text-Frame StoryWritingMode-1']").text
...
#====================================================================================================
  x ='<div class="postnav">
	      <ul>
		<li><a href="politics1.html">1</a></li>
		<li><a href="politics2.html">2</a></li>
		<li><a href="politics3.html">3</a></li>
